...
object Analytic {
    ...
    const val PROFILE_AVATAR_CHANGE = "profile_avatar_change"
    const val PROFILE_AVATAR_CHANGE_AVATAR_KEY = "user_avatar"
    const val PROFILE_AVATAR_CHANGE_NAME_KEY = "user_name"

    const val PROFILE_DATA_CHANGE = "profile_data_change"
    const val PROFILE_DATA_CHANGE_KEY = "user_name"

    const val COCKTAIL_FAVORITE_ADD = "cocktail_favorite_add"
    const val COCKTAIL_FAVORITE_REMOVE = "cocktail_favorite_remove"
    const val COCKTAIL_FAVORITE_ID_KEY = "cocktail_id"
    const val COCKTAIL_FAVORITE_USER_NAME_KEY = "user_name"
