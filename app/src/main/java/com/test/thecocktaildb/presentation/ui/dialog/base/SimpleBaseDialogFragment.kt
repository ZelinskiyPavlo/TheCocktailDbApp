package com.test.thecocktaildb.presentation.ui.dialog.base
...
import com.test.thecocktaildb.presentation.ui.dialog.DialogButton
import com.test.thecocktaildb.presentation.ui.dialog.DialogType
...
protected constructor() : BaseDialogFragment<Data, ButtonType, Type>() {
    ...
    open class SimpleBaseDialogFragmentBuilder constructor() : Parcelable {
        /**
        ...
        companion object CREATOR : Parcelable.Creator<SimpleBaseDialogFragmentBuilder> {
            override fun createFromParcel(parcel: Parcel): SimpleBaseDialogFragmentBuilder {
                return SimpleBaseDialogFragmentBuilder(
                    parcel
                )
            }

            override fun newArray(size: Int): Array<SimpleBaseDialogFragmentBuilder?> {
